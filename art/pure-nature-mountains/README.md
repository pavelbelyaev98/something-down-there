...
- **Integration:** Round site setup authors the permanent gravel apron; meadow setup configures eleven plant layers and pack ground throughout, with a soft turf/soil transition. Linear masks retain alpha, with close-range filtering.
