...
- **Purpose:** Approved meadow plants, turf/soil/sediment/rock/gravel textures and sky for the round worksite. Surrounding scenery is removed from MainGame.
...
- **Integration:** Round site setup authors the permanent gravel apron; meadow setup configures eleven plant layers and pack ground throughout, with a soft turf/soil transition. Ground deposits reuse fine gravel as tinted compacted sediment and the tileable rock detail set; linear masks retain alpha, with close-range filtering.
