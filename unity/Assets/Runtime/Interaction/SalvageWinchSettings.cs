...
namespace SomethingDownThere
{
    ...
    public sealed class SalvageWinchSettings : ScriptableObject
    {
        ...
        [Min(.1f)] public float HaulSpeed = 1.5f;
        ...
        [Range(1f, 5f)] public float MaximumLoadSpeed = 3.2f;
        ...
        [Range(.2f, 1.5f)] public float LoadedGuideLead = 1.05f;
        [Range(1f, 8f)] public float MaximumBurstSpeed = 5f;
        [Range(1f, 5f)] public float MaximumSpin = 3f;
        [Tooltip("Continuous blocked contact under rope tension before soil can break.")]
        [Range(.2f, 2f)] public float ContactStallSeconds = .28f;
        ...
        [Range(1f, 3f)] public float BlockedPullMultiplier = 2.4f;
        ...
        public bool Valid => float.IsFinite(MarkSeconds) && MarkSeconds > 0
            ...
            && BlockedPullMultiplier >= 1 && BlockedPullMultiplier <= 3
            && RetensionSeconds >= .4f && RetensionSeconds <= 3
            && RetensionPullMultiplier >= 3 && RetensionPullMultiplier <= 6
            && TensionReleaseSeconds >= .1f && TensionReleaseSeconds <= 1
